...
public class PostService implements IService<Post>{
    ...
    private String currentRole = user.getRoles();
    ...
    public List<String> getMediaForPost(int postId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String fullPath = "C:/Users/azizz/OneDrive/Bureau/Recyconnect/public/Posts/uploads/" + fileName;
    ...
    public Map<Post, List<String>> getPostsWithMediaByUser(int userId) {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        String sql = "SELECT * FROM post WHERE user_p_id = ? AND status_post = true";
    ...
    public void addWithMedia(Post post, List<String> mediaFilePaths) throws SQLException, IOException {
        ...
        try (PreparedStatement ps = conx.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            String uploadDir = "C:/Users/azizz/OneDrive/Bureau/Recyconnect/public/Posts/uploads/";
    ...
    public boolean analyzePostContent(String content) {
        try {
            ...
            if (result.equals("toxique")) {
                ...
                MailService.sendMail("azizzouari283@gmail.com", "Alerte : Contenu Inapproprié détecté", htmlContent);
