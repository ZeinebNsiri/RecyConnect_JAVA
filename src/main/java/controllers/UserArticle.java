...
public class UserArticle {
    ...
    private void loadArticles() throws SQLException {
        ...
        int currentUserId = utils.Session.getInstance().getCurrentUser().getId();
        List<Article> articles = articleService.getArticlesByUser(currentUserId);
    ...
    private StackPane createArticleCard(Article article) {
        ...
        try {
            ...
            File imageFile = new File("C:/Users/azizz/OneDrive/Bureau/Recyconnect/public/uploads/photo_dir/" + imageName);
            if (imageFile.exists()) {
