...
public class PostDetailController {
    ...
    private VBox creerBlocCommentaire(Commentaire commentaire, int indentLevel) {
        ...
        sendReplyButton.setOnAction(e -> {
            ...
            newReply.setUserComId(user.getId()); // À adapter selon l'utilisateur connecté
    ...
    private void envoyerCommentaire() {
        ...
        commentaire.setUserComId(user.getId()); // À remplacer par l’ID de l'utilisateur connecté
    ...
    private void retourVersListePosts() {
        try {
            ...
            datePostLabel.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
